 ...
 * {@code spin/.spin/build.spin.module.jlink.properties}), not plain {@code java}, when exec runs a
 * real module (the {@code -m rootModule/mainClass} launch path) rather than a classpath app.
 */
public class Main {
